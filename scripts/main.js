...
const templates ={ 
    experience:
     `<div>
        ...
        <p>SASTA: Society for the Advancement of Science and Technology in the Arab World.</p>
        <p>Mar 2022 - Present (8 months +)</p>
        <ul>
            <li> Spearheading the development of the visual display of components in HTML/CSS/Javascript for useas component for incorporation into web pages or other contexts.</li>
            <li>Developing and implementing highly-responsive user interface components using React.</li>
            <li>Monitoring and improving front-end performance.</li>
        </ul>
    </div>
    <div>
        <h3>Frontend React Developer</h3>
        <p>One Community Global</p><p>Jan 2022 - Feb 2022 (2 months)</p>
        <ul>
            <li> Advanced the capabilities of our front end web application with React</li>
            <li>Implemented state management with Redux</li>
            <li>Help breakdown complex work into deliverables working closely with cross-functional team members</li>
        </ul>
     </div>`,
    skills: 
